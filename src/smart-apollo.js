...
export default class SmartApollo {
  ...
  generateApolloOptions (variables) {
    const apolloOptions = omit(this.options, this.kduApolloSpecialKeys)
  ...
  catchError (error) {
    ...
    if (error.graphQLErrors && error.graphQLErrors.length !== 0) {
      ...
      console.error(`[kdu-apollo] An error has occurred for ${this.type} '${this.key}'`)
